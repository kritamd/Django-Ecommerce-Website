...
from .forms import CheckOutForm, CustomerRegistrationForm, CustomerLoginForm,PasswordForgotForm,PasswordResetForm
...
class PasswordResetView(FormView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if user is not None and password_reset_token.check_token(user, token):
            ...
            return redirect(reverse("HamroPasal:passwordforgot") + "?m=e")
